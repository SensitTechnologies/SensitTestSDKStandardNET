	...
	public class Excel
	{
		...
		public void Open(string filename, string worksheet = "")
		{
			...
			else
			{
				...
				_worksheet = (Microsoft.Office.Interop.Excel.Worksheet)_workbook.Worksheets[worksheet];
			}
		}
		...
		public T GetCellValue<T>(int row, int column)
		{
            ...
            return (T)(_worksheet.Cells[row, column] as Microsoft.Office.Interop.Excel.Range).Value;
		}
			...
			string topLeftCell, string bottomRightCell, string title, string xAxisLabel, string yAxisLabel)
		{
			...
			ChartObjects charts = (Microsoft.Office.Interop.Excel.ChartObjects)_worksheet?.ChartObjects();
